...
begin
  ...
  if v_id is null then
    -- Carrera entre grupos (fix 2026-08-29): dos admins creando la misma
    -- categoría casi al mismo tiempo — categories_nombre_unique_idx ya lo
    -- impide a nivel de fila, este catch evita el unique_violation crudo y
    -- hace que el segundo termine vinculándose a la del primero.
    begin
...
begin
  ...
  if v_pid is null then
    -- Carrera entre grupos (fix 2026-08-29): dos coordinadores de grupos
    -- distintos pueden pasar el SELECT de arriba a la vez (ninguno ve el
    -- insumo del otro todavía) e intentar insertar el mismo (category_id,
    -- nombre, unidad) casi al mismo tiempo. El índice único parcial
